...
use twilight_model::id::{ApplicationId, ChannelId, GuildId, UserId};
...
impl From<&CachedGuild> for Guild {
    fn from(v: &CachedGuild) -> Self {
        Self {
            afk_channel_id: v.afk_channel_id(),
